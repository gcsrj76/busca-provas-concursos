...
class ViewBusca(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.btn_buscar = ctk.CTkButton(self.frame_info, text="Varrer Links de Provas", command=self.disparar_busca, fg_color="#2b8a3e")
    ...
    def disparar_busca(self):
        ...
        threading.Thread(target=WebProofService.varrer_provas_web, args=(self.callback_thread,), daemon=True).start()
